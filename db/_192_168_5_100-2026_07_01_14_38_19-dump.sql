...
) ENGINE=InnoDB AUTO_INCREMENT=279 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='审批实例';
...
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文件信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `preparation_process_template` (
  ...
  KEY `idx_preparation_id` (`preparation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='制剂工序模版表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `production_plan` (
  ...
  KEY `fk_production_plan_update_user` (`updated_by`),
  KEY `idx_status` (`current_status`),
  KEY `idx_createdate` (`created_time`),
  KEY `idx_plantype` (`plan_type`),
  KEY `idx_create_user` (`created_by`),
...
CREATE TABLE `role_perm` (
  ...
  `created_by` bigint unsigned DEFAULT NULL COMMENT '授权人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  `updated_by` bigint DEFAULT NULL COMMENT '更新人ID',
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间',
...
-- Dump completed on 2026-07-01 14:38:23
