...
public class FileManagerController extends BaseController {
     ...
     * GET /api/file-manager/operation-log?rootType=business&pageIndex=0&pageSize=20
     * GET /api/file-manager/operation-log?rootType=custom&pageIndex=0&pageSize=20
     *
     ...
     * @param rootType      根目录类型（可选）：business=系统文件/custom=用户文件
    ...
    public ApiResponse<Page<FileOperationLog>> queryOperationLog(
        ...
        try {
            Page<FileOperationLog> result = fileOperationLogService.queryLogs(
                    operationType, userId, userName, businessType, rootType, parseTimeParam(startTime, true), parseTimeParam(endTime, false), pageIndex, pageSize);
            return success(result);
        } catch (Exception e) {
