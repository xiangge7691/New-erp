...
public class TemperatureHumidityRecordController extends BaseRoomRecordController<TemperatureHumidityRecord> {
    ...
    public ApiResponse<PagedResult<TemperatureHumidityRecord>> getAll(
        ...
        try {
            ...
            if (roomName != null || roomCode != null) {
                ...
                Page<TemperatureHumidityRecord> page = createPage(safePageIndex, safePageSize);
                ...
                fillRoomInfo(page.getRecords(), TemperatureHumidityRecord::getRoomId,
                        TemperatureHumidityRecord::setRoomName, TemperatureHumidityRecord::setRoomCode);
            ...
            fillRoomInfo(pageResult.getRecords(), TemperatureHumidityRecord::getRoomId,
                    TemperatureHumidityRecord::setRoomName, TemperatureHumidityRecord::setRoomCode);
